...
#define TERMINAL "st" /* alternatively, "urxvt" */
#define TERMCLASS "St" /* alternatively, "URxvt" */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_F8,                       spawn,          SHCMD("dmenubookmarks") },
	{ MODKEY,                       XK_F9,                       spawn,          SHCMD("dmenuemoji") },
